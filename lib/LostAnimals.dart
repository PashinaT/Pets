...
class LostAnimals extends StatefulWidget {
  LostAnimals({Key key, this.title,this.isFoundPage,this.similar}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return LostAnimalsForm(title,isFoundPage,similar);
  }
...
class LostAnimalsForm extends State<LostAnimals> {
  ...
  LostAnimalsForm(this.title,this.isFoundPage,this.similar);
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Card(
                    child: ListTile(
                      ...
                      subtitle: Text('Цвет:' + item.colorPet),
